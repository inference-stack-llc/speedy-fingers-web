...
export const metadata: Metadata = {
  title: "Support",
  description:
    "Get help with Speedy Fingers gameplay, accessibility settings, progress, and future App Store purchases.",
...
export default function SupportPage() {
  return (
    <LegalShell
      ...
      summary="Quick answers for the first release, plus a direct way to reach the Speedy Fingers team."
    ...
    >
      ...
      <section>
        ...
        <p>
          Watch a short fingerspelled word, then choose the word you recognized.
          Levels can change timing, word length, rounds, and replay allowances.
          Complete a level’s accuracy goal to continue along the journey.
        </p>

        <h3>Where can I study individual letters?</h3>
        <p>
          Open Hand Lab from the app’s navigation. You can review the A–Z
          fingerspelling set and adjust the playback pace before playing a
          sequence.
        </p>
        ...
        <p>
          No. The game focuses specifically on visual fingerspelling
          recognition. It is designed to complement—not replace—broader ASL
          learning and Deaf-led instruction.
        </p>
